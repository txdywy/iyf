...
const SEED_VARIETY = [
  ...
  { id:'seed_var_2026_04', title:'哈哈哈哈哈', year:2026, score:8.2, playCount:300000, contentType:'真人秀·旅行·搞笑', actor:'邓超,陈赫,鹿晗,范志毅,王勉', description:'五哈兄弟团欢乐旅行,全程笑到停不下来。', totalEpisodes:0, isComplete:false, currentEpisode:0, regional:'大陆', lang:'国语', isSerial:true },
  ...
  { id:'seed_var_2026_21', title:'喜人奇妙夜', year:2026, score:7.8, playCount:190000, contentType:'喜剧·竞演·搞笑', actor:'马东,黄渤,巡演,于和伟', description:'一年一度喜剧大赛团队新作, Sketch喜剧竞演,创意与笑点齐飞。', totalEpisodes:0, isComplete:false, currentEpisode:0, regional:'大陆', lang:'国语', isSerial:true },
